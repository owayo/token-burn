...
- **Concurrent-safe state**: Parallel workers update `state.json` with atomic rename under a stable sidecar lock file; malformed existing JSON aborts the update without overwriting previously recorded history
